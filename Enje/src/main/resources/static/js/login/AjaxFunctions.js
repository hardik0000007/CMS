...
function getFinLibPathRealty()
{
    ...
    if(host.search("dev")>-1 || host.search("localhost")>-1  || host.search("192.168")>-1){
...
function getData_sync(dataSource, divID, param,flag)
{
    ...
    if(XMLHttpRequestObject)
    {
        ...
        //        obj.innerHTML ='<img src="./images/load_page.gif"  ><br><div align=center><font class=\'h4_blue\'><b>Loading Page... </b></font></div>';
...
function getData2(dataSource, divID, param)
{
    ...
    if(XMLHttpRequestObject){
        ...
        //        obj.innerHTML = '<img src="../images/load_page.gif" id="imageid"><br><div align=center><font color=#20759c><b>Please wait...</b></font></div>';
        obj.innerHTML = varLoading ;
...
function getRequestBody(oForm) {
    ...
    for (var i=0 ; i < oForm.elements.length; i++)
    {
        ...
        else
        {
            ...
            else if(oForm.elements[i].type == "radio" || oForm.elements[i].type == "RADIO")
            {
                if(oForm.elements[i].checked == true)
                {
...
function getRequestBodyWithoutFile(oForm) {
    ...
    for (var i=0 ; i < oForm.elements.length; i++)
    {
        ...
        else
        {
            ...
            else if(oForm.elements[i].type !== "file" && oForm.elements[i].type !== "FILE")
            {
                sParam = encodeURIComponent(oForm.elements[i].name);
                sParam += "=";
                sParam += encodeURIComponent(oForm.elements[i].value);
